...
import static org.shikshalokam.backend.elevateUtility.UserServiceUtils.fetchProperty;
...
public class MentorBase {
    static{
        ...
        UserServiceUtils.deleteUser(fetchProperty("ep.mail"), fetchProperty("ep.password"),fetchProperty("ep.superadminmail"), fetchProperty("ep.superadminpassword"));
    }
