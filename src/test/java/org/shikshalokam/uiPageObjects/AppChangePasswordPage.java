...
public class AppChangePasswordPage extends PWBasePage{
    ...
    public AppChangePasswordPage changePassword (String oldpassword, String newpassword, String confirmnewpassword) {
        ...
        page.getByLabel("Confirm new password *").fill(confirmnewpassword);
