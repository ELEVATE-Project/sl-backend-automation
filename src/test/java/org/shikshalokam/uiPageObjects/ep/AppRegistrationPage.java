...
public class AppRegistrationPage extends PWBasePage {
    ...
    public AppRegistrationPage(String givenTitleName) {
...
//    Based on org select and enter the registration code
    ...
    public static void getOTPAndFill() {
        ...
        Boolean gotoHome=page.getByRole(AriaRole.BUTTON, new Page.GetByRoleOptions().setName("Go to Home")).isVisible();
        if (gotoHome) {
